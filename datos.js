...
const CLIENTES = [
  ...
  { id: "C-06", nombre: "Raul Dominguez", telefono: "6•• ••• •63", email: "raul.dominguez@correo.com", desde: "2019-02-27", motos: [
  ...
  { id: "C-07", nombre: "Cristian Ortega", telefono: "6•• ••• •31", email: "cristian.ortega@correo.com", desde: "2023-05-09", motos: [
      { marca: "Yamaha", modelo: "Tenere 700", anyo: 2023, matricula: "4567 KLP", km: 6980, color: "#16a085" } ] },
  { id: "C-08", nombre: "Luis Marin", telefono: "6•• ••• •55", email: "luis.marin@correo.com", desde: "2017-04-18", motos: [
...
const GASTOS_MES = [
  ...
  { concepto: "Cuota de autonomo", importe: 294, tipo: "Fijo" },
  { concepto: "Gestoria", importe: 145, tipo: "Fijo" },
  { concepto: "Publicidad y redes", importe: 210, tipo: "Variable" },
  { concepto: "Herramienta y utillaje", importe: 166, tipo: "Variable" }
];

const TOP_RECAMBIOS = [
  { nombre: "Filtro de aceite", uds: 46 },
